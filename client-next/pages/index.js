...
import BackpacksTable from "../src/components/BackpacksTable";
import TraitsTable from "../src/components/TraitsTable";
import {scrollToTop, upperFirstLetter} from "../src/components/helpers";
import columns from "../src/components/columnClasses";
...
function Index() {
  ...
  useEffect(() => {
    ...
    databaseNames.forEach((databaseName) => {
      console.log(window[databaseName]);
