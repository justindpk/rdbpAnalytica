        ...
        return (
          <tr key={index}>
            ...
            <td><a href={`https://opensea.io/assets/0x7a4d1b54dd21dde804c18b7a830b5bc6e586a7f6/${duck.duck}`}
                   target="_blank" rel="noreferrer"><Image width={30} height={30} src={"/img/opensea.svg"} alt="opensea"
