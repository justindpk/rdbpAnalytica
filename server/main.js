...
//     // let response = fetch(database_url);
...
// // });
// //
// // parseAllDucks().then((data) => console.log(data)).catch((err) => {
// //   console.log(err);
// // })
//
const axios = require('axios');
axios.get('https://duck.art/rarity-data/v9/allDucks.js').then(console.log).catch(console.log)
// fetch('https://duck.art/rarity-data/v9/allDucks.js')